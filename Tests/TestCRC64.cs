...
namespace Cave.CRC.Tests
{
    ...
    public class TestCRC64
    {
        ...
        readonly ulong[] ecma_182_table = new ulong[]
        {
        ...
        public void Test_CRC64_Check()
        {
            ...
            Assert.AreEqual((ulong)0x08040201f8f4f2f1, u);
            ...
            {
                CRC64 crc64 = CRC64.WE;
                //check expected table against calculated table
                CollectionAssert.AreEqual(ecma_182_table, crc64.Table);
                //check crc test value
                Check(crc64, new byte[0], 0x0);
