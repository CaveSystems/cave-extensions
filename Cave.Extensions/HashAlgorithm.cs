...
namespace System.Security.Cryptography
{
    ...
    public abstract class HashAlgorithm : IDisposable
    {
        ...
        /// <summary>
        /// Computes the hash value for the specified region of the input byte array and copies the specified region of the input byte array to the specified
        ...
        /// </summary>
        /// <remarks>
        /// This method is not called by application code. <br/> This abstract method performs the hash computation.Every write to the cryptographic stream
        /// object passes the data through this method.For each block of data, this method updates the state of the hash object so a correct hash value is
        /// returned at the end of the data stream.
        /// </remarks>
