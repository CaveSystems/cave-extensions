...
namespace Cave
{
    ...
    public static class TimeZones
    {
        ...
        public static TimeZoneData[] GetList()
        {
            return new[]
            {
                GMT, CET, FWT, MET, MEWT, SWT, EET, BT, ZP4, ZP5, ZP6, CXT, CCT, AWST, WST, JST, EAST, GST, IDLE, NZST, NZT, WAT, AT, AST, EST, CST, MST,
                PST, AKST, YST, HST, HAST, CAT, NT, IDLW, ADT, EDT, CDT, MDT, PDT, AKDT, YDT, HADT, HDT, BST, IST, WEDT, WEST, CEDT, CEST, MEST, MESZ, SST,
                FST, EEDT, EEST, WADT, EADT, NZDT, MEZ, ACDT, ACST, NDT, NFT, NST, A, B, C, D, E, F, G, H, I, K, L, M, N, O, P, Q, R, S, T, U, V, W, X, Y,
                Z
            };
        }
        ...
        public static string[] GetNames()
        {
            return new[]
            {
                "GMT", "CET", "FWT", "MET", "MEWT", "SWT", "EET", "BT", "ZP4", "ZP5", "ZP6", "CXT", "CCT", "AWST", "WST", "JST", "EAST", "GST", "IDLE",
                "NZST", "NZT", "WAT", "AT", "AST", "EST", "CST", "MST", "PST", "AKST", "YST", "HST", "HAST", "CAT", "NT", "IDLW", "ADT", "EDT", "CDT",
                "MDT", "PDT", "AKDT", "YDT", "HADT", "HDT", "BST", "IST", "WEDT", "WEST", "CEDT", "CEST", "MEST", "MESZ", "SST", "FST", "EEDT", "EEST",
                "WADT", "EADT", "NZDT", "MEZ", "ACDT", "ACST", "NDT", "NFT", "NST", "A", "B", "C", "D", "E", "F", "G", "H", "I", "K", "L", "M", "N", "O",
