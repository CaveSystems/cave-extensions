...
/// <summary>
/// Gets an interface for 2D set implementations (Each set A and B may only contain each value once. If typeof(A) == typeof(B) a value
/// may be present once at each set. Each value in set a is linked to a value in set b via its index).
/// </summary>
