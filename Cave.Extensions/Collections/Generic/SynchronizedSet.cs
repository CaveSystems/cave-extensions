    ...
    where T : notnull
{
    ...
    /// <summary>Gets a <see cref="SynchronizedSet{T}"/> containing all objects part of the first set after removing all objects present at the second set.</summary>
    /// <param name="set1">The first set used to calculate the result.</param>
    /// <param name="set2">The second set used to calculate the result.</param>
    /// <returns>Returns a new <see cref="SynchronizedSet{T}"/> containing the result.</returns>
    ...
    /// <summary>
    /// Subtracts the specified <see cref="SynchronizedSet{T}"/> from this one and returns a new <see cref="SynchronizedSet{T}"/> containing the result.
    /// </summary>
    /// <param name="set1">The first set used to calculate the result.</param>
    /// <param name="set2">The second set used to calculate the result.</param>
    /// <returns>Returns a new <see cref="SynchronizedSet{T}"/> containing the result.</returns>
