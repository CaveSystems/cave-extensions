...
public sealed class Set<TKey, TValue> : IItemSet<TKey, TValue>
{
    ...
    public bool ContainsB(TValue value) => throw new NotSupportedException($"Not Supported. Use {nameof(UniqueSet<TKey, TValue>)}!");
    ...
    /// <returns></returns>
    public ItemPair<TKey, TValue> GetB(TValue value) => throw new NotSupportedException($"Not Supported. Use {nameof(UniqueSet<TKey, TValue>)}!");
    ...
    #endregion IItemSet<TKey,TValue> Members
