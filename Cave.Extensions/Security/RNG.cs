...
{
    /// <summary>
    /// Provides cryptographically strong random number functions.
    /// </summary>
    public static class RNG
    {
        ...
        public static int GetInt32(int fromInclusive, int toExclusive)
        {
            ...
            for (var value = Int32; ; value = Int32)
            {
                if (value < fromInclusive && value >= toExclusive) return value;
            }
        }
        ...
        /// <summary>
        /// Gets a cryptographically strong random value within full valid range of the target value.
        /// </summary>
        public static int Int32
        {
            get
            {
                return Convert.ToInt32(GetBytes(4));
            }
        }
        ...
        public static long Int64
        {
            get
            {
                return Convert.ToInt64(GetBytes(8));
            }
        }
        ...
        public static uint UInt32
        {
            get
            {
                return Convert.ToUInt32(GetBytes(4));
            }
        }
        ...
        public static ulong UInt64
        {
            get
            {
                return Convert.ToUInt64(GetBytes(8));
            }
        }
    }
}
