...
namespace Cave
{
    ...
    public class CRCCCITT16 : HashAlgorithm, IChecksum<ushort>
    {
        ...
        /// cryptographic stream object passes the data through this method.For each block of data, this method updates the state of the hash object so
        /// a correct hash value is returned at the end of the data stream.
        /// </remarks>
