...
{
    /// <summary>
    /// Provides extensions working on the bits of system types.
    /// </summary>
    public static class BitwiseExtensions
    {
        ...
        /// A rotate is a shift (see SHL and SHR) that wraps around; the leftmost bit of the operand is shifted into the rightmost bit,
        ...
        /// A rotate is a shift (see SHL and SHR) that wraps around; the rightmost bit of the operand is shifted into the leftmost bit,
