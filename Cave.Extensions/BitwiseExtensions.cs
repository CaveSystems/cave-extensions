namespace Cave
{
    ...
    public static class BitwiseExtensions
    {
        ...
        ///     (MSB). A rotate is a shift (see SHL and SHR) that wraps around; the leftmost bit of the operand is shifted into the
        ///     rightmost bit, and all intermediate bits are shifted one bit to the left. Except for the direction the shift
        ///     operation takes, ROL is identical to ROR.
        /// </summary>
        ...
        ///     bit (LSB). A rotate is a shift (see SHL and SHR) that wraps around; the rightmost bit of the operand is shifted
        ///     into the leftmost bit, and all intermediate bits are shifted one bit to the right. Except for the direction the
        ///     shift operation takes, ROR is identical to ROL.
        /// </summary>
        /// <param name="value">The value to rotate.</param>
        /// <param name="count">The number of bits to rotate.</param>
        /// <returns>The bitwise rotated value.</returns>
