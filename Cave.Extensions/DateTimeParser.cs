...
namespace Cave
{
    ...
    public static class DateTimeParser
    {
        ...
        {
            var result = ParseDateTime(text, out utcDateTime, out offset);
            return result.Time.Valid || result.Date.Valid;
        }
        ...
        /// <summary>
        ///     Tries to find a valid timezone within the passed string and returns it. To obtain the full offset you have to
        ///     use TimeZoneData.Offset + Offset.
        /// </summary>
        ...
        /// <summary>
        ///     Tries to find time within the passed string. Detects [h]h:mm[:ss[.f[f[f[f[f[f]]]]]]][offset] [PM/AM] [UTC/GMT]
        ///     using a a single regex.
        /// </summary>
        ...
        /// <summary>
        ///     Tries to find date within the passed string and return it as DateTimeString object. It recognizes only date
        ///     while ignoring time, so time in the returned DateTimeString is always 0:0:0. If year of the date was not found then
