...
namespace Cave
{
    ...
    public class CRC64 : HashAlgorithm, IChecksum<ulong>
    {
        ...
        /// <summary>
        /// The polynomial used to generate the table.
        /// </summary>
        ...
        /// <summary>
        /// The reflect input flag.
        /// </summary>
        public bool ReflectInput;

        /// <summary>
        /// The reflect output flag.
        /// </summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CRC64"/> class. Creates a new CRC64.XZ: width=64 poly=0x42f0e1eba9ea3693 init=0xffffffffffffffff
        /// refin=true refout=true xorout=0xffffffffffffffff check=0x995dc9bbdf1939fa residue=0x49958c9abd7d353f name="CRC-64/XZ".
        /// </summary>
        public CRC64()
        ...
        /// <summary>
        /// Computes the hash for the specified data. The caller needs to <see cref="Initialize"/> the <see cref="CRC64"/> first and call <see
        /// cref="HashFinal"/> afterwards to obtain the full hash code.
        /// </summary>
