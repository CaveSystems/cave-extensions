...
/// <summary>Gets access to LATESTVERSION files.</summary>
public struct LatestVersion : IComparable<LatestVersion>, IEquatable<LatestVersion>
{
    ...
    public static LatestVersion Empty =>
        new()
        {
            AssemblyVersion = new(0, 0),
            FileVersion = new(0, 0),
            SetupVersion = new(0, 0),
            ReleaseDate = default,
    ...
    /// <summary>Checks whether the specified latest version is newer then the current one.</summary>
    ...
    /// <summary>Gets <see cref="LatestVersion" /> comparison.</summary>
    ...
    public static bool operator <(LatestVersion v1, LatestVersion v2)
    {
        ...
        {
            throw new ArgumentException("Softwarename does not match!");
        }
    ...
    public static bool operator <=(LatestVersion v1, LatestVersion v2) => (v1 < v2) || (v1 == v2);
    ...
    public static bool operator ==(LatestVersion v1, LatestVersion v2) => v1.Equals(v2);
    ...
    /// <summary>Gets or sets name of the Software this LatestVersion belongs to.</summary>
    public string SoftwareName { get; set; }

    /// <summary>Gets or sets the Assembly <see cref="Version" />.</summary>
    public Version AssemblyVersion { get; set; }

    /// <summary>Gets or sets the File <see cref="Version" />.</summary>
    public Version FileVersion { get; set; }

    /// <summary>Gets or sets the Installer <see cref="Version" />. (This is the version used while comparing two instances).</summary>
    public Version SetupVersion { get; set; }

    /// <summary>Gets or sets path of update.</summary>
    public Uri UpdateURI { get; set; }

    /// <summary>Gets or sets the SoftwareFlags.</summary>
    public SoftwareFlags SoftwareFlags { get; set; }

    /// <summary>Gets or sets the release date.</summary>
    public DateTime ReleaseDate { get; set; }

    /// <summary>Gets or sets the SetupPackage fileName.</summary>
    public string SetupPackage { get; set; }

    /// <summary>Gets or sets the setup arguments.</summary>
    public string SetupArguments { get; set; }

    #endregion

    /// <summary>Returns "{<see cref="SoftwareName" />} {<see cref="AssemblyVersion" />}".</summary>
    /// <returns>software name and assembly version.</returns>
    public override string ToString() => $"{SoftwareName} {AssemblyVersion}";

    /// <summary>Gets the hashcode of this instance.</summary>
    ...
    {
        var result = AssemblyVersion.CompareTo(other.AssemblyVersion);
        if (result == 0)
        {
    ...
    /// <summary>Checks two <see cref="LatestVersion" /> instances for equality.</summary>
