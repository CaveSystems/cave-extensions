...
namespace Cave
{
    ...
    public static class ASCII
    {
        ...
        public static class Bytes
        {
            ...
            public static IList<byte> LowercaseLetters => new byte[]
            {
            ...
            public static IList<byte> UppercaseLetters => new byte[]
            {
                0x41, 0x42, 0x43, 0x44, 0x45, 0x46, 0x47, 0x48, 0x49, 0x4a, 0x4b, 0x4c, 0x4d, 0x4e, 0x4f, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57,
                0x58, 0x59, 0x5a
            };
            ...
            public static IList<byte> CRLF => new[] { CR, LF };
            ...
            {
                0x20, 0x23, 0x28, 0x29, 0x2B, 0x2D, 0x2E, 0x30, 0x31, 0x32, 0x33, 0x34, 0x35, 0x36, 0x37, 0x38, 0x39, 0x3D, 0x40, 0x41, 0x42, 0x43, 0x44,
                0x45, 0x46, 0x47, 0x48, 0x49, 0x4A, 0x4B, 0x4C, 0x4D, 0x4E, 0x4F, 0x50, 0x51, 0x52, 0x53, 0x54, 0x55, 0x56, 0x57, 0x58, 0x59, 0x5A, 0x5F,
                0x61, 0x62, 0x63, 0x64, 0x65, 0x66, 0x67, 0x68, 0x69, 0x6A, 0x6B, 0x6C, 0x6D, 0x6E, 0x6F, 0x70, 0x71, 0x72, 0x73, 0x74, 0x75, 0x76, 0x77,
                0x78, 0x79, 0x7A
            };
        }
        ...
        /// <exception cref="ArgumentNullException">bytes.</exception>
        /// <exception cref="InvalidDataException">Byte '{0}' at index '{1}' is not a valid ASCII character!.</exception>
        public static string GetString(byte[] bytes, int start, int count, bool termination = false) => new string(GetChars(bytes, start, count, termination));
        ...
        /// <summary>
        ///     Escapes the character by its hexadecimal representation (<![CDATA[\'x'YY]]> or <![CDATA[\'u'YYYY]]> depending on
        ///     the charset).
        /// </summary>
