...
public sealed class FileFinder : IDisposable
{
    ...
    /// <summary>Retrieves the next file found. This function waits until a file is found or the search thread completes without finding any further items.</summary>
